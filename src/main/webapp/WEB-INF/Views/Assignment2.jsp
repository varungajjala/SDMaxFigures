...
<div class="main" id="dimensionsNotRound" data-role="tooltip">
    ...
    <h2 class="title"> Find Max Cube </h2>
...
<form method="post">
    ...
    <div class="col-xs-12 subclass"> 
        <div class="col-xs-12">
	        ...
	        <div class="form-group col-xs-12">
	        	...
	        	<input class="form-control col-sm-8" name="inp-length" type="text" value="${len}"></input>	        	
	        </div>
	        <div class="form-group col-xs-12">
    ...
    <div class="col-xs-12 subclass">
        <div class="buttoncenter">            
            <input type="submit" class="btn btn-success" id="calcbtn" value="Calculate Result" >
        </div>
    </div>
    ...
    <div class="col-xs-12 subclass">
        ...
        <div class="col-xs-4 "> <span class="labels">Cube Side Length 1</span>
            <input class="numeric-textbox form-control" id="op-sidelen" name="op-length" type="text" value="${sidelen1}" onchange="return getValue();" /> 
        </div>
        <div class="col-xs-4 "> <span class="labels">Cube Side Length 2</span>
            <input class="numeric-textbox form-control" id="op-sidelen" name="op-length" type="text" value="${sidelen2}" onchange="return getValue();" /> 
        </div>
